...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .brand-logo { width: 52px; height: 52px; padding: 0; border-radius: 14px; background: #fff; object-fit: contain; box-sizing: border-box; box-shadow: 0 10px 24px rgba(17,39,68,0.12); flex-shrink: 0; }
