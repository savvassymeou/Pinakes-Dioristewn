...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .brand-logo { width: min(132px, 38vw); height: min(132px, 38vw); padding: 10px; border-radius: 50%; background: #fff; object-fit: contain; box-sizing: border-box; box-shadow: 0 12px 28px rgba(16, 54, 96, 0.14); flex-shrink: 0; }
        ...
        <header class="topbar">
            <div class="topbar-inner">
                <a class="brand" href="index.php">
                    <img class="brand-logo" src="<?php echo h(path_from_root("assets/images/ichnos-logo.jpg") . "?v=20260402"); ?>" alt="<?php echo h(APP_NAME); ?> logo"><span class="brand-copy"><strong><?php echo h(APP_NAME); ?></strong><span><?php echo h(APP_TAGLINE); ?></span></span>
                </a>
